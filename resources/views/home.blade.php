                                    ...
                                    <div class="widget-body widget-hide-overflow no-padding">
                                        ...
                                        <div id="chat-container">
                                            ...
                                            <div class="chat-list-body custom-scroll">
                                                <ul id="chat-users">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{url('img/avatars/sunny.png')}}" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="chat-body" class="chat-body custom-scroll">
                                            <ul>
                                                ...
                                                <li class="message">
                                                    <img src="{{url('img/avatars/sunny.png')}}" class="online" alt="">
                                                    <div class="message-text">
                                                        <time>
                                                            2014-01-13
