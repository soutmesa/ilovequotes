                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('marital_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="marital_status" type="text" class="form-control" name="marital_status" required>
                        ...
                        <div class="form-group{{ $errors->has('place_of_birth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="place_of_birth" type="place_of_birth" class="form-control" name="place_of_birth" required> </textarea>
