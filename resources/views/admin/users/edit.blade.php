...
<html lang="en-us">
    ...
    <body class="">
                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="checkout-form" class="smart-form" method="PUT" action="{{url('users/update', $user->id)}}">
                                            {{ csrf_field() }}
                                            <header>
                                                Registration form
                                            </header>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <section class="col col-6">
                                                        <label class="input"> <i class="icon-append fa fa-user"></i>
                                                            <input type="text" value="{{$user->user_name}}" name="user_name" placeholder="Username">
                                                    ...
                                                    <section class="col col-6">
                                                        <label class="select">
                                                            <select name="gender">
                                                                ...
                                                                <option value="Male" {{strtolower($user->gender)=="male"?'selected="selected"' : ''}} >Male</option>
                                                                <option value="Female" {{strtolower($user->gender)=="female"?'selected="selected"' : ''}} >Female</option>
                                                            </select> <i></i> </label>
                                                    </section>
                                                    <section class="col col-6">
                                                        <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                                            <input type="text" value="{{$user->date_of_birth}}" name="date_of_birth" placeholder="Date of birth" class="datepicker" data-dateformat='dd/mm/yy'>
                                                        </label>
                                                    </section>
                                                </div>
                                                    ...
                                                    <section class="col col-6">
                                                        <label class="select">
                                                            <select name="marital_status">
                                                                ...
                                                                <option value="Married" {{ isSelected($user->marital_status, 'married') }} >Married</option>
                                                                <option value="Divorced" {{ isSelected($user->marital_status, 'divorced') }} >Divorced</option>
                                                                <option value="Single" {{ isSelected($user->marital_status, 'single') }} >Single</option>
                                                            </select> <i></i> </label>
                                                    </section>
                                                    
                                                    <section class="col col-6">
                                                        <label class="input"> <i class="icon-append fa fa-phone"></i>
                                                            <input type="tel" value="{{$user->phone}}" name="phone" placeholder="Phone" data-mask="(999) 99-999-999">
                                                        </label>
                                                    </section>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                        <label class="textarea">                                        
                                                            <textarea rows="3" name="address" placeholder="Place of birth">{{$user->place_of_birth}}</textarea> 
                                                        </label>
                                                    </section>
                                                </div>
        ...
        $(document).ready(function() {
            ...
            $(".js-example-placeholder-multiple").select2().val({{$user->roles()->getRelatedIds()}}).trigger('change');
            pageSetUp();
