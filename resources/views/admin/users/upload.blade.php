                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="checkout-form" class="smart-form"  enctype="multipart/form-data" method="POST" action="{{url('users/imageUpload', $user->id)}}">
                                            {{ csrf_field() }}
                                            <header>
                                                Upload form
                                            </header>
                                                ...
                                                <div class="widget-body">
                                                    <section class="col-sm-12">
                                                        <div class="input input-file">
                                                            <span class="button"><input id="file2" type="file" name="profile" onchange="this.parentNode.nextSibling.value = (this.value).replace(/.*\\/ig,'')">Browse</span><input type="text" placeholder="Include some files" readonly="" name="profile" >
                                                        </div>
                                                    </section>
                                                </div>
