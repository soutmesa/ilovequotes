                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            @foreach($permissions as $permission)
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="{{ url('permissions/edit', $permission->id) }}"><span><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></a> | 
                                                        <a href="{{ url('permissions/delete', $permission->id) }}" onclick="return confirm('This action cannot be undone . Are you sure you want to delete this account ?')"><span><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
