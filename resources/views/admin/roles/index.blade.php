                                            ...
                                            @foreach($roles as $role)
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="{{ url('roles/delete', $role->id) }}" onclick="return confirm('This action cannot be undone . Are you sure you want to delete this account ?')" ><span><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
