...
<html lang="en-us">
    ...
    <body class="">
                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="checkout-form" class="smart-form" method="POST" action="{{url('roles/update', $role->id)}}">
                                            {{ csrf_field() }}
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6 form-group">
                                                        <select style="width:100%" class="js-example-placeholder-multiple select2" name="permissions[]" multiple="multiple">
        ...
        $(document).ready(function() {
            ...
            $(".js-example-placeholder-multiple").select2().val({{$role->permissions()->getRelatedIds()}}).trigger('change');
            pageSetUp();
