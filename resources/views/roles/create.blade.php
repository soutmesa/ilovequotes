                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="checkout-form" class="smart-form" method="POST" action="{{url('roles/store')}}">
                                            {{ csrf_field() }}
                                            <header>
                                                Registration form
                                            </header>
                                                ...
                                                <div class="row">
                                                    <section class="col col-6">
                                                        <label class="textarea">                                        
                                                            <textarea rows="3" name="description" placeholder="describe here..."></textarea> 
                                                        </label>
                                                    </section>
                                                    <section class="col col-6 form-group">
                                                        <select style="width:100%" class="js-example-placeholder-multiple" name="permissions[]" multiple="multiple">
