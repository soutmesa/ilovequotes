                                                    ...
                                                    <section class="col col-6">
                                                        <label class="select">
                                                            <select name="marital_status">
                                                                ...
                                                                <option value="Married" {{strtolower($user->marital_status)=="married"?'selected="selected"' : ''}} >Married</option>
                                                                <option value="Divorced" {{strtolower($user->marital_status)=="divorced"?'selected="selected"' : ''}} >Divorced</option>
                                                                <option value="Single" {{strtolower($user->marital_status)=="single"?'selected="selected"' : ''}} >Single</option>
                                                            </select> <i></i> </label>
                                                    </section>
                                                    {{$user->phone}}
                                                    <section class="col col-6">
