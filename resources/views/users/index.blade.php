...
<html lang="en-us">
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            @elseif ($message = Session::get('pwd'))
                <div class="alert alert-success">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <p>{{ $message }}</p>
                </div>
            ...
            @elseif ($message = Session::get('profile'))
                <div class="alert alert-success">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <p>{{ $message }}</p>
                </div>
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            <thead>                         
                                                <tr>
                                                    ...
                                                    <th><i class="fa fa-fw fa-venus-mars txt-color-blue hidden-md hidden-sm hidden-xs"></i> Gender</th>
                                                    ...
                                                    <th data-hide="" align="center"><i class="fa fa-fw fa-cogs text-muted hidden-md hidden-sm hidden-xs"></i> Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="{{ url('users/edit', $user->id) }}"><span><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></a> | 
                                                        <a href="{{ url('users/delete', $user->id) }}"><span><i class="fa fa-trash-o" aria-hidden="true"></i></span></a> | 
                                                        <a href="{{ url('users/show', $user->id) }}"><span><i class="fa fa-eye" aria-hidden="true"></i></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
