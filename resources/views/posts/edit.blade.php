                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="checkout-form" class="smart-form" method="POST" action="{{url('posts/update', $post->id)}}">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="_method" value="PATCH">
                                            <header>
                                                Registration form
                                            </header>
                                            <input type="hidden" name="user_id" value="{{$post->user['id']!=''? $post->user['id']:Auth::user()->id}}"/>
                                            <fieldset>
