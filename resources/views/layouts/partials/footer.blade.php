        ...
        <script data-pace-options='{ "restartOnRequestAfter": true }' src="{{ url('js/p') }}lugin/pace/pace.min.js"></script>
        ...
        <script src="{{ url('js/plugin/flot/jquery.flot.cust.min.js') }}"></script>
        <script src="{{ url('js/plugin/flot/jquery.flot.resize.min.js') }}"></script>
        <script src="{{ url('js/plugin/flot/jquery.flot.time.min.js') }}"></script>
        <script src="{{ url('js/plugin/flot/jquery.flot.tooltip.min.js') }}"></script>
        
        <!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
        <script src="{{ url('js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
        <script src="{{ url('js/plugin/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
        
        <!-- Full Calendar -->
        <script src="{{ url('js/plugin/moment/moment.min.js') }}"></script>
        <script src="{{ url('js/plugin/fullcalendar/jquery.fullcalendar.min.js') }}"></script>
